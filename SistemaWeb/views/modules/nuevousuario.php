...
<script>
  $(document).ready(function () {
    $('#new').submit(function (e) {
      ...
      $.ajax({
        type: 'POST',
        url: "https://laboratoriosad.000webhostapp.com/agregarUsuario.php",
        data: formData,
  ...
  <body>
    <div class="divFormulario">
      <div class="divTituloLogin">
        <h4>Informacion del nuevo usuario</h4>
      </div>
      <form id="new">
        <div class="mb-3">
            <label for="cedula" class="form-label" style="font-weight:bold;">Cedula</label>
            <input type="text" class="form-control" name="cedula" id="cedula" maxlength="10" placeholder="Cedula del Usuario" required>
          </div>
          <div class="mb-3">
            <label for="nombre" class="form-label" style="font-weight:bold;">Nombre</label>
            <input type="text" class="form-control" name="nombre" id="" placeholder="Nombre del Usuario" required>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="telefono" id="telefono" placeholder="Telefono del Usuario" required>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="clave" id="clave" placeholder="Clave del Usuario" required>
          </div>
          <div>
